...
router.get(    '/user_transaction/mpesa_callback',       TransactionController.mpesa_callback); 
router.get(    '/user_transaction/mpesa_c2bvalidation',        TransactionController.mpesa_c2bvalidation); 
